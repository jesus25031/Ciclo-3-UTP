    ...
    <main>
        ...
        <section class="container-ven">
            ...
            <div class="seccion-Tabla">
                    ...
                    <br><div class="ventana_interaccion">
                        <div class="inputs">
                        ...
                        <div class="buttons">
                            <div>
                                <v-btn id="vender" color="principal" @click="prepararDatos()">Vender</v-btn>
                                <v-btn id="cancelar" color="principal" @click="btn_cancelar()">Cancelar</v-btn>
                            </div>
                        </div>
                    </div>
            </div>
